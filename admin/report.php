			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Reporting Details</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Reporting Info</div>
...
<div id="print">
					<table border="1"  class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%"  >
						...
						<?php 
$status=1;
$sql = "SELECT tblusers.*,tblbrands.BrandName,tblvehicles.VehiclesTitle,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.VehicleId as vid,tblbooking.Status,tblbooking.PostingDate,tblbooking.id,tblbooking.id,
...
<tr>
	...
	<td><?php
	$tdays = $result->totalnodays;
	$ppdays = $result->PricePerDay;
	 if (!is_null($tdays)) echo htmlentities($tdays * $ppdays); else echo htmlentities($ppdays) ;?></td>
</tr>
<tr>
...
<?php } ?>
		<?php $cnt=$cnt+1;}} ?>
		<tr>
    <th colspan="3" style="text-align:center">Grand Total of All Bookings</th>
    <td>
        <?php
        ...
        foreach ($bookingResults as $result) {
            ...
            // Calculate the individual total for this booking
            $individualTotal = (!is_null($tdays)) ? $tdays * $ppdays : $ppdays;

            // Add the individual total to the grand total
