...
<title>Abi Car Sale & Rental</title>
<!--Bootstrap -->
...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblvehicles.Vtype,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.SeatingCapacity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand limit 9";
...
<span class="price">$<?php echo htmlentities($result->PricePerDay); if(htmlentities($result->Vtype) == "Rental") echo ' /Day'?> </span> 
</div>
...
chatbotId: "FKCxAxx0UuC11Pr8yDpgN",
