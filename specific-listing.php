...
<head>
    ...
    <title>Abi Car Sale & Rental | Specific cars</title>
    <!--Bootstrap -->
...
<a href="car-listing.php" class="btn" style='color: white;'>all</a>
<a href="specific-listing.php?vfor=Rental"  class="btn" style='color: white; margin-left: 10px'>Rental</a>
<a href="specific-listing.php?vfor=Sale" class="btn" style='color: white; margin-left: 10px'>Sale</a>
</div>
<?php $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where vType=:vfor";
$query = $dbh -> prepare($sql);
$query->bindParam(':vfor',$vfor, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
if($query->rowCount() > 0)
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">Birr <?php echo htmlentities($result->PricePerDay);if(htmlentities($result->Vtype) == "Rental") echo ' Per Day'?></p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> seats</li>
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> model</li>
              <li><i class="fa fa-bolt"></i><?php echo htmlentities($result->FuelType);?></li>
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->Vtype);?></li>
            </ul>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">Birr <?php echo htmlentities($result->PricePerDay); if(htmlentities($result->Vtype) == "Rental") echo ' Per Day'?> </p>
                </div>
              </li>
              <?php }} ?>
